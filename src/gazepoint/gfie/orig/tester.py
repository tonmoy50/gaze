...
import numpy as np
from utils.utils import AverageMeter,MovingAverageMeter,euclid_dist,visualized,cosine_sim, auc
    ...
    def test(self,epoch,opt):
        ...
        for i,data in enumerate(self.testloader,0):
            ...
            for b_idx in range(bs):
                ...
                # print("CameraParameter ", type(cur_campara))
                ...
                pred_result=strategy3dGazeFollowing(cur_depmap,cur_pred_gazeheatmap,cur_pred_gazevector,cur_eye_3d,cur_campara)
        ...
        if self.writer is not None:
            ...
            self.writer.add_scalar("3D Eval dist", self.test_dist3d.avg, global_step=opt.OTHER.global_step)
